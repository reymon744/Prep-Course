...
function devolverString(str) {
  var string = str;// "Return" la string provista: str
...
function esPositivo(numero) {
  ...
  if (numero > 0) {
    var espositivostring = 'Es positivo'
    return espositivostring;
  }
  else if (numero < 0) {
    var esnegativostring = 'Es negativo';
    return esnegativostring;
  }
  return false;
}
